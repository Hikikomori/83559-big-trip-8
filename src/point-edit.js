...
class PointEdit extends Component {
  ...
  <form class="point__form" action="" method="get">
    <header class="point__header">
      ...
      <label class="point__time">
        ...
        value=
        "${this._startDate.toLocaleString(`en-gb`, {hour: `numeric`, minute: `numeric`}) + ` — ` +
    ...
    return `<input class="point__offers-input visually-hidden" type="checkbox" id="${offer.value}" name="offer" value="${offer.value}">
  ...
  createListeners() {
    ...
    this._element.querySelector(`.point__form`)
      .addEventListener(`submit`, this._submitListenerBind);
    this._element.querySelector(`.point__form`)
