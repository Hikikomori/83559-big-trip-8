  ...
  return `<article class="trip-point">
    ...
    <p class="trip-point__schedule">
      <span class="trip-point__timetable">
        ${startDate.toLocaleString(`en-gb`, {hour: `numeric`, minute: `numeric`})}&nbsp;&mdash; 
        ${endDate.toLocaleString(`en-gb`, {hour: `numeric`, minute: `numeric`})}
      </span>
      <span class="trip-point__duration">
        ${Math.floor(durationInMinutes / MINUTES_IN_HOUR)}h ${durationInMinutes % MINUTES_IN_HOUR}m
      </span>
    </p>
